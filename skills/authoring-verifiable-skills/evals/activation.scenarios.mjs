...
const scenarios = [
  // ---------------------------------------------------------------- positive
  {
    ...
    mode: "router",
    difficulty: "obvious",
    prompt: "my debugging skill keeps proposing a fix before anyone has even reproduced the bug. it did it twice today",
  ...
  },
  {
    ...
    mode: "exception",
    difficulty: "hard",
    prompt: "the debugging skill has that states table, right? i want one of those in my naming-conventions skill so it feels more structured",
    expectedPrimary: "rules/states-carry-licenses.md",
  ...
  },
  {
    ...
    mode: "router",
    difficulty: "obvious",
    prompt: "my notes skill fires on basically everything i ask, even requests that have nothing to do with notes",
    expectedPrimary: "rules/activation-surface.md",
    expectedSecondary: [],
